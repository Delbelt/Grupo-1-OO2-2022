...
@Controller
@RequestMapping(Routes.PRINCIPAL_MATTER) // matter route
@Slf4j
public class MatterController {
	...
	// Type: Path variable
	@GetMapping(Routes.EDIT_MATTER) // Al pasarle el parametro {idMatter} lo relaciona con el parametro de Matter
	...
	@PostMapping(Routes.EDIT_POST_MATTER)
	...
	@GetMapping(Routes.DELETE) // Relaciona el idMatter en el HTML con el controlador para "apuntar" al correcto
